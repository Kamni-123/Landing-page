    ...
    <div className=" bg-red-50 flex flex-col justify-top items-center mt-16">
      ...
      <div className="flex justify-center items-center p-20 w-screen gap-60">
        <h1 className=" w-1/2 font-bold text-6xl">
          ...
          <h2 className="text-lg font-normal mt-5">
            ...
            library.
            <div className="underline text-lg flex justify-centre w-32 gap-2 mt-10 font-bold  items-center">Learn More <FaLongArrowAltRight/> </div>
          </h2>
        </h1>
        <a
          className="bg-white"
        ...
        >
          <video width={550} controls>
            <source
              src="https://videos.ctfassets.net/ccli4xdzdc9p/48qt4KWj9ScDKwKutPYRCu/56a7e95c145225c94bb37242b7947731/Script_to_Image_Fast.mp4"
              type="video/mp4"
            />
      ...
      <div className="flex justify-center items-center p-20 w-screen gap-60">
        ...
        >
          <video width={550} controls>
            <source
              src="https://videos.ctfassets.net/ccli4xdzdc9p/HaE8ws0oNQzEMPQkVsMpf/2dd7c01e4dfebc4204ed647d0638ac4d/commenting.mp4"
              type="video/mp4"
            />
            Your browser does not support the video tag.
          </video>
        ...
        Centralize Team Communication...
          <h2 className="text-lg font-normal mt-5">
          Boords helps you establish clear communication between creatives and clients with commenting, approvals, real-time updates, and more. Say goodbye to confusing email threads and missing feedback.
          <div className="hover:underline text-lg flex justify-centre w-32 gap-2 mt-10 font-bold  items-center">Learn More <FaLongArrowAltRight/> </div>
          </h2>
      ...
      <div className="flex justify-center items-center mt-5 gap-4 p-3">
        <img
          ...
          width={50}
        />
        <span className=" mt-5 font-semibold">Producer at CatCow</span>
